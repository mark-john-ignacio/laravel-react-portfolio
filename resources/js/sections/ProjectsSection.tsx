                    ...
                    {featured.map((p, idx) => (
                        <Reveal key={p.id} index={idx} distance={40} className="grid items-center gap-10 md:grid-cols-2">
                            <button
                                ...
                                className={`order-2 ${idx % 2 === 0 ? 'md:order-1' : 'md:order-2'} group relative focus:outline-none`}
                            ...
                            <div className={`order-1 ${idx % 2 === 0 ? 'md:order-2' : 'md:order-1'} relative`}>
                                ...
                                <div className="mb-4 rounded bg-[#112240] p-6 text-[#8892b0] shadow-lg ring-1 ring-[#1d2d50]">{p.description}</div>
                                ...
                                <div className="flex gap-4 font-mono text-sm">
                                    {p.links?.github && (
                                        <a href={p.links.github} target="_blank" rel="noreferrer" className="text-[#64ffda] hover:underline">
                                            GitHub
                                        </a>
                                    )}
                                    {p.links?.demo && (
                                        <a href={p.links.demo} target="_blank" rel="noreferrer" className="text-[#64ffda] hover:underline">
                                            Live Demo
                                        </a>
                                    )}
                                    <button
