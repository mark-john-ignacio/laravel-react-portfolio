...
export default function EditProject({ project }: { project: Project }) {
    ...
    return (
        <AppLayout>
            ...
            <main className="p-4">
                <h1 className="mb-4 text-2xl font-bold text-green-400">$ projects edit --id {project.id}</h1>
                    ...
                    <CardContent className="p-6">
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input
                                    id="technologies"
                                    value={(data.technologies as string[]).join(', ')}
                                    onChange={(e) =>
                                        setData(
                                            'technologies',
                                            e.target.value
                            ...
                            <div className="flex gap-3">
                                ...
                                <Link href={route('admin.projects.index')} className="self-center text-cyan-400 underline">
                                    cancel
                                </Link>
                            </div>
                        </form>
